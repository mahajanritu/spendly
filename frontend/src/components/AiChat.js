...
export default function AiChat() {
  ...
  useEffect(() => {
    if ('webkitSpeechRecognition' in window || 'SpeechRecognition' in window) {
      ...
      recognitionRef.current.lang = 'hi-IN'; // Hindi + English support
  ...
  const generateReport = async () => {
    ...
    setMessages(m => [...m, { role: 'user', text: '📊 Monthly financial report banao' }]);
    try {
      const { data } = await API.get('/ai/report');
      setMessages(m => [...m, { role: 'ai', text: data.report }]);
    } catch {
      setMessages(m => [...m, { role: 'ai', text: '❌ Report generate nahi ho saki. Dobara try karo!' }]);
    } finally {
    ...
    <>
      ...
      <button
        ...
        style={{
          ...
          boxShadow: '0 4px 24px rgba(124,107,255,0.6)',
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <div>
                <div style={{ fontWeight: 700, fontSize: 14 }}>Spendly AI</div>
          ...
          <div style={{
            ...
            {messages.map((msg, i) => (
              <div key={i} style={{
                ...
                {msg.role === 'ai' && (
                  <div style={{ fontSize: 18, marginRight: 6, alignSelf: 'flex-end' }}>🤖</div>
                )}
                <div style={{
                  maxWidth: '78%',
                  padding: '10px 14px',
           ...
           {suggestions.map(s => (
              <button key={s} onClick={() => sendMessage(s)}
                style={{
                  ...
                  borderRadius: 20, cursor: 'pointer', color: 'var(--text2)',
          ...
          <div style={{
            ...
            <input
              ...
              placeholder={listening ? '🎤 Listening...' : 'Kuch bhi poochho...'}
              value={input}
